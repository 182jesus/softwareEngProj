...
public class loginScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        menuOutputField = new javax.swing.JTextPane();
        ...
        viewCreateBill.setMinimumSize(new java.awt.Dimension(425, 540));
                    ...
                    .addGroup(viewCreateBillLayout.createSequentialGroup()
                        ...
                        .addGroup(viewCreateBillLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(viewCreateBillLayout.createSequentialGroup()
                                ...
                                .addGap(34, 34, 34)
                                .addGroup(viewCreateBillLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
        ...
        createMonthPull.setFont(new java.awt.Font("Tahoma", 0, 10));
        ...
        createYearPull.setFont(new java.awt.Font("Tahoma", 0, 10));
        createYearPull.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Year", "----", "2011", "2012", "2013" }));

        createDayPull.setFont(new java.awt.Font("Tahoma", 0, 10));
        ...
        HomeScreen.setMinimumSize(new java.awt.Dimension(565, 444));
        ...
        createMenu.setMinimumSize(new java.awt.Dimension(450, 450));
        ...
        jScrollPane6.setViewportView(menuOutputField);
        ...
        createMenuLayout.setHorizontalGroup(
            ...
            .addGroup(createMenuLayout.createSequentialGroup()
                ...
                .addGroup(createMenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(createMenuLayout.createSequentialGroup()
                        .addGap(112, 112, 112)
                        .addComponent(priceOfItem, javax.swing.GroupLayout.PREFERRED_SIZE, 82, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(createMenuLayout.createSequentialGroup()
                        .addComponent(jLabel59)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(itemToAdd, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        budgetingMenu.setTitle("Budgeting Menu -- Percula");
        budgetingMenu.setMinimumSize(new java.awt.Dimension(680, 590));
        ...
        budgetingStartDay.setFont(new java.awt.Font("Tahoma", 0, 10));
        ...
        budgetingStartMonth.setFont(new java.awt.Font("Tahoma", 0, 10));
        ...
        budgetingEndMonth.setFont(new java.awt.Font("Tahoma", 0, 10));
        ...
        budgetingEndYear.setFont(new java.awt.Font("Tahoma", 0, 10));
        budgetingEndYear.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Year", "----", "2011", "2012", "2013" }));

        budgetingEndDay.setFont(new java.awt.Font("Tahoma", 0, 10));
        ...
        budgetingStartYear.setFont(new java.awt.Font("Tahoma", 0, 10));
        ...
        updateBudgeting.setTitle("Update Budgeting Screen -- Percula");
        updateBudgeting.setMinimumSize(new java.awt.Dimension(595, 575));

        updateBudgetStartMonth.setFont(new java.awt.Font("Tahoma", 0, 10));
        ...
        updateBudgetStartDay.setFont(new java.awt.Font("Tahoma", 0, 10));
        ...
        updateBudgetStartYear.setFont(new java.awt.Font("Tahoma", 0, 10));
        updateBudgetStartYear.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Year", "----", "2011", "2012", "2013" }));

        updateBudgetEndDay.setFont(new java.awt.Font("Tahoma", 0, 10));
        ...
        updateBudgetEndYear.setFont(new java.awt.Font("Tahoma", 0, 10));
        updateBudgetEndYear.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Year", "----", "2011", "2012", "2013" }));

        updateBudgetEndMonth.setFont(new java.awt.Font("Tahoma", 0, 10));
   ...
   try {
    ...
    private void login(){   
           ...
           if("manager".equals(username) && "hello".equals(passwords)){         //if the username is manager
            ...
            }else if("staff".equals(username) && "hi".equals(passwords)){
            //staff = true ; 
            count =2 ;  //sets count at 2
            passwordInput.setText("");

            System.out.println("logging in with less available");
            }else if("temp staff".equals(username) && "orite".equals(passwords)){
                //tempStaff = true;
                count = 3;      //sets count at 3
                passwordInput.setText("");

                System.out.println("logging you in with nothing availabnle");
            }else if("neo".equals(username)){
                count = 4;
                usernameInput.setText("");
            }
            else JOptionPane.showMessageDialog(loginDialog,"Incorrect user login details, Please try again.");
  ...
  /*method to create menus*/
    public void createMenu(){
        ...
        menuOutputField.setText(createMenuTypeOutput.toString() +" \n" + createMenuStyleOutput.toString()
                ...
                priceOfItemOutput);
        /*try writing the menu to its own external file then 
         have a method to read it in and display it into menuOutputField 
         ie write out and save then read back in and display
         
         Could NOT be arsed writing this method at...1am.....
         fuck this imma go sleep :) have fun doing this tomorrow scott,....*/
    ...
    public void viewBudgeting () {
        Object budgetingStartDayOutput = budgetingStartDay.getSelectedItem();
        Object budgetingStartMonthOutput = budgetingStartMonth.getSelectedItem();
        Object budgetingStartYearOutput = budgetingStartYear.getSelectedItem();
        Object budgetingEndDayOutput = budgetingEndDay.getSelectedItem();
        Object budgetingEndMonthOutput = budgetingEndMonth.getSelectedItem();
        Object budgetingEndYearOutput = budgetingEndYear.getSelectedItem();
        
        System.out.println(budgetingStartDayOutput + "  " + budgetingStartMonthOutput +
                "  " + budgetingStartYearOutput);
        System.out.println(budgetingEndDayOutput + "  " + budgetingEndMonthOutput +
                " " + budgetingEndYearOutput);
      
       // budgetingTable.add(budgetingStartDayOutput.toString());
        
    //    budgetingTable.print(budgetingStartDayOutput.toString());
        
        budgetingTable.add(budgetingStartDayOutput.toString(), budgetingTable);
  ...
  /*  String newMonth;
    ...
    private javax.swing.JTextPane menuOutputField;
